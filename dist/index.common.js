...
var EXCLUDE_PATH = parseIgnore__default["default"](fs__default["default"].readFileSync(".cfignore"));
/** Java文件后缀 */
...
var TemplateTools = /*#__PURE__*/function () {
  function TemplateTools(pj) {
    ...
    if (pj.templateDir.length == 0) {
      // TODO: 修正
      pj.templateDir = path__default["default"].join(pj.projectDir, pj.projectName);
    }
  ...
  _createClass(TemplateTools, [{
    ...
    value: function showStructure(formData, obj) {
      var dirStructure = {
        ...
        sortPath: obj ? path__default["default"].relative(this.projectPath, obj.path) : path__default["default"].relative(this.projectPath, this.project.templateDir),
        formData: formData,
        isDir: true,
        children: []
      };
...
var CodeGenerator = /*#__PURE__*/function () {
  ...
  _createClass(CodeGenerator, [{
    ...
    value: function getMapper() {
      fs__default["default"].writeFileSync(this.params.releasePath, mapper(this.project, this.params));
    }
  }, {
    key: "getController",
    value: function getController() {
      fs__default["default"].writeFileSync(this.params.releasePath, controller(this.project, this.params));
    }
  }, {
    key: "getServiceImpl",
    value: function getServiceImpl() {
      fs__default["default"].writeFileSync(this.params.releasePath, serviceImpl(this.project, this.params));
    }
  }, {
    key: "getUnitTest",
    value: function getUnitTest() {
      fs__default["default"].writeFileSync(this.params.releasePath, unitTest(this.project, this.params));
    }
    /**
